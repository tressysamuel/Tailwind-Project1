...
function FittsLaw() {
  return (
    <div>
      <NavBar className="md:flex hidden"prev="/article/2" next="/article/4" ></NavBar>
         
     
      <AestheticImage className="py-28  bg-emerald-500" text="FItt's Law" number="03/20" fillingColor="rgb(16 185 129)">
